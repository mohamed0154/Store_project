...
<nav class="navbar main-nav fixed-top navbar-expand-lg">
  <div class="container">
      <a class="navbar-brand" href="#" >Mf Documentation</a>
      ...
      <ul class="navbar-nav ml-auto menu">
      	<li class="nav-item">
          <a class="nav-link" target="_blank" href="{{route('login')}}">Sign In</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" target="_blank" href="{{route('register')}}">Sign Up</a>
        </li>
      </ul>
      </div>
  </div>
		...
		<div class="row">
			<div class="col-12 text-center">
                ...
                <a style="width:239px" href="{{route('login')}}" class="btn btn-main-rounded">Sine in</a><br><br> -->
                 ...
                 <img src="{{asset('admin\images\github-logo.png')}}" alt=""></a><br><br>
				 <a href="{{route('login_redirect','google')}}" class="btn btn-main-rounded">Login Google
                 <img src="{{asset('admin\images\google-logo.png')}}" width='28px' height='28px' alt=""></a><br><br>
				 <a href="{{route('login_redirect','facebook')}}" class="btn btn-main-rounded">Login FaceBook
                 <img src="{{asset('admin\images\facebook-logo.png')}}" width='24px' height='24px' alt=""></a>
